...
ZADANIE: Określ, czy to słowo reprezentuje postać, miejsce lub postać historyczną w książce.
...
Jeśli słowo NIE jest postacią, miejscem ani postacią historyczną, ustaw `is_valid` na false.
...
Uwaga: Jeśli typ to "location", element powinien zawierać "name" i "description". Jeśli typ to "historical_figure", element powinien zawierać "name", "biography" i "role".

Jeśli `is_valid` jest false:
{
  "is_valid": false,
  "error_message": "Krótkie wyjaśnienie, dlaczego to nie jest postać ani miejsce."
}]],
